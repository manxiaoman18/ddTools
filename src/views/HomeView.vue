...
const cardList = [
  ...
  // { id: 6, title: '讯飞AI', path: '/xunFeiAI', icon: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"><path d="M408 64H104a56.16 56.16 0 0 0-56 56v192a56.16 56.16 0 0 0 56 56h40v80l93.72-78.14a8 8 0 0 1 5.13-1.86H408a56.16 56.16 0 0 0 56-56V120a56.16 56.16 0 0 0-56-56z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="32"></path><circle cx="160" cy="216" r="32" fill="currentColor"></circle><circle cx="256" cy="216" r="32" fill="currentColor"></circle><circle cx="352" cy="216" r="32" fill="currentColor"></circle></svg>' },
]
