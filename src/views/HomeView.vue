...
<template>
  <div class="container">
    <n-grid cols="2 s:3 m:4 l:5 xl:6" responsive="screen" :x-gap="12" :y-gap="12">
      <n-gi v-for="card in cardList" :key="card.id">
        <Card :title="card.title" @click="() => router.push(card.path)">
...
.logo:hover {
  filter: drop-shadow(0 0 0.5em var(--card-shadow));
}
